package MYDan::MonitorV3::NodeExporter::Collector::Sar;
use strict;
use warnings;
use Carp;
use POSIX;
use MYDan::MonitorV3::NodeExporter::Collector::Sar::Table;
...
sub co
{
    my $data = shift;
    my ( $error, @res ) = (0);
    my @data = MYDan::MonitorV3::NodeExporter::Collector::Sar::Table::co( $data );
